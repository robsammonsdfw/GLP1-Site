      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-20">
          ...
          <div>
            ...
            >
              <img 
                src="https://www.legitscript.com/wp-content/uploads/2023/10/legitscript-seal.png" 
          ...
          <div>
             ...
             <ul className="space-y-4 text-white/50 font-medium text-sm">
              <li><a href={`${MAIN_SITE}/about`} className="hover:text-[#F26422] transition-colors">About Us</a></li>
