...
const Header: React.FC = () => {
  ...
  const MAIN_SITE = "https://www.embracehealth.ai";
  ...
  const EXPLORE_FEATURES = [
    { name: 'Physical Intelligence', path: `${MAIN_SITE}/app/physical-intelligence` },
    { name: 'Nutrition & Kitchen Intelligence', path: `${MAIN_SITE}/app/nutrition-kitchen` },
    { name: 'Mental Health', path: `${MAIN_SITE}/app/mental-health` },
    { name: 'Progress Tracking', path: `${MAIN_SITE}/app/progress-tracking` },
    { name: 'Browse All App Features', path: `${MAIN_SITE}/app/features` },
  ];
      ...
      >
        <div className="max-w-[1450px] mx-auto px-6 md:px-12 flex items-center justify-between h-full">
          ...
          <div className="flex items-center">
            <a href={MAIN_SITE} className="text-2xl font-bold text-[#002534] flex items-center">
        ...
        >
          <div className="max-w-[1450px] mx-auto px-12 py-12 flex">
            ...
            <div className="flex-1 px-12 flex space-x-8">
              <a href={`${MAIN_SITE}/article/science-of-glp1`} className="flex-1 group cursor-pointer block">
                <div className="rounded-3xl overflow-hidden aspect-[16/10] mb-4 bg-gray-100">
                  <img src="https://picsum.photos/seed/glp1/800/500" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="GLP-1 Science" referrerPolicy="no-referrer" />
                </div>
              ...
              <div className="flex-1 group cursor-pointer">
                <div className="rounded-3xl overflow-hidden aspect-[16/10] mb-4 bg-gray-100">
                  <img src="https://picsum.photos/seed/dna/800/500" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="DNA Wellness" referrerPolicy="no-referrer" />
                </div>
            ...
            <div className="w-1/4 pl-12">
              <div className="bg-[#002534] rounded-[2.5rem] p-8 text-white h-full flex flex-col justify-between">
                ...
                <a href="https://shop.embracehealth.ai/collections/weight-loss" className="w-full py-4 bg-[#00B6A0] rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-white hover:text-[#002534] transition-all text-center">
                  Start Visit
                </a>
              </div>
            </div>
        ...
        <div className="p-8 space-y-12 pb-24">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              <a href="https://coach.embracehealth.ai" className="w-full py-5 bg-[#00B6A0] text-white rounded-2xl font-bold text-center text-lg">Coaches/Providers</a>
              <a href="https://employer.embracehealth.ai" className="w-full py-5 bg-[#F26422] text-white rounded-2xl font-bold text-center text-lg">Employers/Brokers</a>
            </div>
          </div>
          ...
          <div className="space-y-6">
             ...
             <div className="flex space-x-8 text-[#002534]">
                <a href="https://www.facebook.com/embracehealthai/" className="font-bold text-sm">Facebook</a>
                <a href="https://www.tiktok.com/@embracehealthai" className="font-bold text-sm">TikTok</a>
                <a href="https://www.snapchat.com/@embracehealthai" className="font-bold text-sm">Snapchat</a>
             </div>
          </div>
        </div>
      </div>
